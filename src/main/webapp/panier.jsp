...
<section class="flex-around">
    ...
    <section>
        ...
        <div class="flex-centre">
            <div class="garantie flex-around">
                ...
                <h3 class="size-lien-garantie bordure-garantie"><i class="fa-solid fa-calendar-check fa-lg"></i>
                    Garantie
                    1an
                </h3>
                <h3 class="size-lien-garantie bordure-garantie"><i class="fa-solid fa-puzzle-piece fa-lg"></i> Recevez
                    votre
                    échantillon
                </h3>
    ...
    <div class="container">
        <div class="row flex-around ">
            <video class="card card-autre" autoplay='autoplay' muted='' loop='infinite'
                   src="images/designer.mp4"></video>
        </div>
        <br>
        <br>
