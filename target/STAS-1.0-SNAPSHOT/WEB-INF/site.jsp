...
<head>
    ...
    <meta charset=" utf-8"/>
    <title>STAS</title>
    <link rel="icon" type="image/ico" href="img/Projet%20stas%20icone.png">


</head>
<body>
<section class="flex-around">
    <img width="100" height="100" src="img/Projet%20stas%20icone.png">
    ...
    <a>
        <button class="btn" href="CreationCompte">Identifiant</button>
    </a>
</section>
<nav>
...
<div class="flex-column-centre">
    ...
    <img src="img/couronne.png" alt="image de site en ligne">
</div>
